...
import com.example.jsonexcersise.ProductShop.entities.categories.CategoryImportDTO;
import com.example.jsonexcersise.ProductShop.entities.products.ProductImportDTO;
import com.example.jsonexcersise.ProductShop.entities.users.User;
import com.example.jsonexcersise.ProductShop.entities.users.UserImportDTO;
import com.example.jsonexcersise.ProductShop.repositories.CategoryRepository;
import com.example.jsonexcersise.ProductShop.repositories.ProductRepository;
...
public class SeedServiceImpl implements SeedService {
    ...
    private static final String USERS_JSON_PATH = "src/main/resources/files/productShop/users.json";
    private static final String CATEGORIES_JSON_PATH = "src/main/resources/files/productShop/categories.json";
    private static final String PRODUCTS_JSON_PATH = "src/main/resources/files/productShop/products.json";
    ...
    public void seedProducts() throws FileNotFoundException {
        ...
        ProductImportDTO[] productImportDTO = this.gson.fromJson(fileReader, ProductImportDTO[].class);
